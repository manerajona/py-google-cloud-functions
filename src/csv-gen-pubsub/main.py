...
def generate_report(cloud_event):
    ...
    logging.info('Received message: {}'.format(request_json))
    ...
    try:
        ...
        logging.info('Report generated: {}'.format(result))
    except IOError as error:
        logging.error('An error occurred generating report: {}'.format(str(error)))